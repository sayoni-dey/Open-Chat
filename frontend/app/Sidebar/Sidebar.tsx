  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 left-4 z-50 p-2 bg-white dark:bg-[#2a2b2d] text-gray-700 dark:text-gray-300 border-gray-300 dark:border-[#3a3a3d] hover:bg-[#3e3e3e] text-gray-300 rounded-lg border border-[#424242] transition-colors shadow-md"
        ...
        <div className={`flex flex-col flex-1 overflow-hidden transition-opacity duration-200 ${isOpen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
          ...
          <div className="p-3 flex flex-col flex-1 overflow-hidden pt-1">
            ...
            <button 
              ...
              className="flex items-center justify-between px-4 py-2.5 text-sm font-medium text-gray-900 dark:text-gray-100 border-gray-300 dark:border-[#3a3a3d] hover:bg-gray-200 dark:hover:bg-[#202123] border border-[#424242] rounded-xl hover:bg-[#212121] transition-colors mb-4 w-full disabled:opacity-50 shadow-sm"
            >
              <span>New Chat</span>
            ...
            <div className="flex-1 overflow-y-auto space-y-1 pr-1 custom-scrollbar">
              <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider px-2 mb-2">Chats</h3>
                ...
                chatHistory.map((item) => (
                  <button
                    ...
                    className={`w-full flex items-center gap-2 px-2.5 py-2 text-sm rounded-lg text-left truncate transition-colors ${
                      chatId === item._id ? 'bg-[#212121] text-white font-medium border border-[#3a3a3a]' : 'text-gray-400 hover:bg-[#212121] hover:text-gray-200'
                    }`}
                  >
